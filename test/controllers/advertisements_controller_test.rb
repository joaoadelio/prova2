...
class AdvertisementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post advertisements_url, params: { advertisement: { descricao: @advertisement.descricao, preco: @advertisement.preco, titulo: @advertisement.titulo, visualizacao: @advertisement.visualizacao } }
    end
  ...
  test "should update advertisement" do
    patch advertisement_url(@advertisement), params: { advertisement: { descricao: @advertisement.descricao, preco: @advertisement.preco, titulo: @advertisement.titulo, visualizacao: @advertisement.visualizacao } }
